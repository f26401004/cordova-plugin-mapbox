...
*/
    ...
    setScrollable: function (scrollable, successCallback, errorCallback, id) {
        id = id || 0;
        cordova.exec(successCallback, errorCallback, "Mapbox", "SET_SCROLLABLE", [id, scrollable]);
    },

    setScalable: function (scalable, successCallback, errorCallback, id) {
        id = id || 0;
        cordova.exec(successCallback, errorCallback, "Mapbox", "SET_SCALABLE", [id, scalable]);
    },
    ...
    checkSource: function (sourceId, successCallback, errorCallback, id) {
        id = id || 0;
        cordova.exec(successCallback, errorCallback, "Mapbox", "CHECK_SOURCE", [id, sourceId])
    },

    checkLayer: function (layerId, successCallback, errorCallback, id) {
        id = id || 0;
        cordova.exec(successCallback, errorCallback, "Mapbox", "CHECK_LAYER", [id, layerId])
    },
